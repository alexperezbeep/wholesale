...
export default function Home() {
  ...
  const [formData, setFormData] = useState({
    motivation: '', repairs: '', timeline: '', address: '',
    name: '', email: '', phone: '', how: '', concern: ''
  });
  ...
  const handleOption = (name: string, value: string) => {
    setFormData({ ...formData, [name]: value }); next();
  };
  ...
  const Button = (props: any) => (
    <button {...props} style={{
      ...
      marginBottom: '0.75rem', background: '#eff6ff',
      border: 'none', borderRadius: '8px', color: '#1e3a8a',
  ...
  return (
    <main style={{ maxWidth: '700px', margin: '0 auto', padding: '4rem 1rem', fontFamily: 'Inter, sans-serif' }}>
      <section style={{ textAlign: 'center', marginBottom: '4rem' }}>
        ...
        {step === 0 && (
          <button onClick={next} style={{
            background: '#2563eb', color: '#fff', padding: '1rem 2rem',
            borderRadius: '8px', fontWeight: 500, marginTop: '1.5rem', cursor: 'pointer'
          }}>
            Get My Cash Offer
          </button>
        )}
      ...
      <section>
        {step === 1 && <StepCard title="Why are you looking to sell?">
        ...
        {step === 5 && <StepCard title="What's your name?">
        ...
        {step === 6 && <StepCard title="What's your email?">
        ...
        {step === 7 && <StepCard title="What's your phone number?">
        ...
        {step === 8 && <StepCard title="How did you hear about us?">
        ...
        {step === 9 && <form onSubmit={handleSubmit}>
        ...
        {step === 10 && <StepCard title="Hang tight… we're reviewing your info!">
      ...
      <section style={{
        ...
        <h2 style={{ fontSize: '1.75rem', fontWeight: 600, marginBottom: '2rem' }}>What Our Clients Say</h2>
        <div style={{
          maxWidth: '500px',
          margin: '0 auto',
          ...
          <img
            ...
            style={{ width: '120px', height: '120px', objectFit: 'cover', borderRadius: '9999px', marginBottom: '1rem' }}
          />
          <p style={{ fontStyle: 'italic' }}>"{testimonials[currentTestimonial].quote}"</p>
          <p style={{ marginTop: '1rem', fontWeight: 'bold', color: '#a5b4fc' }}>

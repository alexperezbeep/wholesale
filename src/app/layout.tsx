...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className="antialiased bg-white text-black dark:bg-zinc-900 dark:text-white">
      <body className={`${inter.className}`}>
        ...
        >
          ...
          <div style={{ textAlign: "center", color: '#6b7280', marginTop: "2.5rem", fontSize: "1.05rem", fontFamily: 'Inter, system-ui, sans-serif', fontWeight: 400 }}>
